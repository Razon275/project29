...
function setup() {
	...
	var options={
	 ...
	 box17=new Box(940,300,30,40)
	 box18=new Box(970,300,30,40)
	 box19=new Box(1000,300,30,40)
	 box20=new Box(1030,300,30,40)
	 box21=new Box(1060,300,30,40)
	 box22=new Box(970,260,30,40)
	 box23=new Box(1000,260,30,40)
	 box24=new Box(1030,260,30,40)
	 box25=new Box(1000,220,30,40)
...
function mouseDragged(){
	...
	function keyPressed(){
		if(keyCode===32){
			Body.setPosition(Polygon,{x:110,y:300})
